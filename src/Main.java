...
public class Main {
    public static void main(String[] args) {
        Voiture voiture1 = new Voiture("150TUN6598", "Toyota", 100000);
        Voiture voiture2 = new Voiture("123TUN9821", "Honda", 45000);
        Voiture voiture3 = new Voiture("135TUN3265", "Ford", 55000);

        // Création de quelques clients
        Client client1 = new Client(1, "Wassef", "Chargui");
        Client client2 = new Client(2, "Yassine", "Chargui");
        Client client3 = new Client(3,"faouzi","Chargui");
